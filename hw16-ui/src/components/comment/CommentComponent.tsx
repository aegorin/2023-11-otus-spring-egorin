...
export default function CommentComponent(props: {comment: CommentBook, handleDelete : (comment: CommentBook) => void}) {
        ...
        {!editMode ? 
          <div>
            ...
            <div className="row-buttons">
              ...
              <button onClick={() => handleDelete(comment)} className="button-link red-btn">Удалить</button>
            </div>
          </div>
        : null}
        </>
