...
public class CommentServiceImpl implements CommentService {
    ...
    @Override
    @CircuitBreaker(name = "DatabaseBreaker", fallbackMethod = "findByBookIdFallback")
    ...
    private List<CommentUpdateDto> findByBookIdFallback(Exception exception) {
        log.error(exception.getMessage(), exception);
        return List.of(new CommentUpdateDto(-1L, "Comment blank"));
    }
}
